    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          transition-all shadow-lg shadow-violet-500/30 hover:scale-105"
        >
          <Plus size={20} />
          Ajouter une dépense
        </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            ...
            <TrendingUp className="text-fuchsia-400" size={32} />
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                {['Date', 'Description', 'Catégorie', 'Montant', 'Actions'].map((h) => (
              ...
              {filteredExpenses.length === 0 ? (
                ...
                filteredExpenses.map((expense) => (
                  <tr key={expense.id} className="hover:bg-white/5">
                    ...
                    <td className="px-6 py-4 text-white font-medium">{expense.amount.toFixed(2)} €</td>

                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">

                        <button
                          onClick={() => setIsModalOpen(true) || setSelectedExpense(expense)}
      ...
      <MaterielModal
        isOpen={isModalOpen}
        onClose={() => { setIsModalOpen(false); setSelectedExpense(undefined); }}
